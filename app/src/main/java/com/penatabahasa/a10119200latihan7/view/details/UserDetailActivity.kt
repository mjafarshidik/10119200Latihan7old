...
import com.penatabahasa.a10119200latihan7.databinding.ActivityUserDetailBinding
...
class UserDetailActivity : AppCompatActivity() {
    ...
    private fun setDataToView(detailList: DetailResponse) {
        binding?.apply {
            ...
            detailsTvName.text = detailList.name ?: resources.getString(R.string.no_name)
            detailsTvUsername.text = detailList.login
            detailsTvBio.text =
                if (detailList.bio == null) resources.getString(R.string.no_bio) else detailList.bio.toString()
                    .trim()
            ...
            detailsTvCompany.text = detailList.company ?: resources.getString(R.string.no_company)
            detailsTvLocation.text =
                detailList.location ?: resources.getString(R.string.no_location)
            detailsTvBlog.text =
                if (detailList.blog == "") resources.getString(R.string.no_blog) else detailList.blog
        }
